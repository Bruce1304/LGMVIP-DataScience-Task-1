...
def rgb2gray(rgb):
    return np.dot(rgb[..., :3], [0.2989, 0.5870, 0.2240])
...
gray = rgb2gray(ss)   # first we will convert image to black and white means gray scale

i = 255-gray   # 0,0,0 is for darkest color and 255,255,255 is for brightest color which is probably white color

# to convert it into blur imag
blur = scipy.ndimage.filters.gaussian_filter(i, sigma=15)
# sigma is the intensity of blurness of image
r = dodge(blur, gray)  # this function will convert our sketch by taking two parameter as blur and gray

cv2.imwrite('mountain-sketch.png', r)
